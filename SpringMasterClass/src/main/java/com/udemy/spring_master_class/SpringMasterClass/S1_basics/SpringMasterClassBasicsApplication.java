...
public class SpringMasterClassBasicsApplication {

//  What are the beans?    			- @Component
//	Dependencies of the bean?  		- @Autowired
//	Where to search for the bean	- applicationContext.getBean(<beanClass>)
	public static void main(String[] args) {
		ApplicationContext applicationContext= SpringApplication.run(SpringMasterClassBasicsApplication.class, args);
